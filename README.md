...
1. [**Gender Classification**](./Computer-Vision/Gender%20Detection)
   - **Models:** ResNet50
...
2. [**Rock Paper Scissors Classification**](./Computer-Vision/Rock%20Paper%20Scissors%20Classification)
...
3. [**German Traffic Sign Recognition (GTSRB)**](./Computer-Vision/GTSRB%20-%20German%20Traffic%20Sign%20Recognition%20Benchmark)
   - **Models:** Custom CNN (Sequential)
   - **Dataset:** GTSRB - German Traffic Sign Recognition Benchmark
   - **Description:** A multi-class CNN classifier that recognizes 43 types of German traffic signs from low-resolution images. The model is exported in SavedModel, TF-Lite, and TensorFlow.js formats for cross-platform deployment.

### 📝 NLP Projects

4. [**Twitter Sentiment Classification**](./NLP-Projects/Twitter%20Sentiment%20Classification)
   - **Models:** Logistic Regression, Random Forest, BERT
   - **Dataset:** Twitter Sentiment Dataset
   - **Description:** Analyzing 8 label from tweets.

5. [**Gojek App Review Sentiment Analysis**](./NLP-Projects/Gojek%20Sentiment%20Analysis)
   - **Models:** SVM (TF-IDF), Random Forest (Word2Vec), IndoBERT (Transformer)
   - **Dataset:** Gojek Google Play Store Reviews (≥ 11,000 scraped reviews)
   - **Description:** Binary sentiment classification (positif/negatif) of Indonesian Gojek app reviews scraped directly from the Google Play Store. Three schemes are benchmarked against each other, with IndoBERT achieving the highest accuracy.

### 📊 Structured Data ML

6. [**Obesity Classification**](./Structured-Data-ML/Obesity%20Classification)
...
7. [**Bitcoin Price Forecast**](./Time-Series/Bitcoin%20Price%20Forecast)
   - **Models:** Baseline LSTM + Custom Multi-Head Attention, Seq2Seq LSTM + Attention
   - **Dataset:** Bitcoin multivariate time-series dataset (price, volume, and technical indicators)
   - **Description:** A multivariate forecasting project to predict future Bitcoin price movements using deep learning-based sequence modeling with a 300-step window and 24-step forecast horizon.

### 🛠️ ML Apps

8. [**Tabular Machine Learning Automation**](./ML-Apps/Machine-Learning-Dashboard)
